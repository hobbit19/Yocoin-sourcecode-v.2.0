...
// deployYocstats deploys a new yocstats container to a remote machine via SSH,
// docker and docker-compose. If an instance with the specified network name
// already exists there, it will be overwritten!
func deployYocstats(client *sshClient, network string, port int, secret string, vhost string, trusted []string, banned []string, nocache bool) ([]byte, error) {
...
func checkYocstats(client *sshClient, network string) (*yocstatsInfos, error) {
