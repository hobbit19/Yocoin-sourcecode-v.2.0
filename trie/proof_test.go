...
// test all variations.
func makeProvers(trie *Trie) []func(key []byte) *yocdb.MemDatabase {
	var provers []func(key []byte) *yocdb.MemDatabase

	// Create a direct trie based Merkle prover
	provers = append(provers, func(key []byte) *yocdb.MemDatabase {
		proof := yocdb.NewMemDatabase()
