...
type Database struct {
	diskdb yocdb.Database // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb yocdb.Database) *Database {
	return &Database{
		diskdb:    diskdb,
...
func (db *Database) commit(hash common.Hash, batch yocdb.Batch) error {
