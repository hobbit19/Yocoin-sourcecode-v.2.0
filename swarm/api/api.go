...
import (
	...
	"github.com/Yocoin15/Yocoin_Sources/swarm/multihash"
	"github.com/Yocoin15/Yocoin_Sources/swarm/spancontext"
...
// ValidateOwner checks the ENS to validate that the owner of the given domain is the given yoc address
...
it is the public interface of the FileStore which is included in the yocoin stack
*/
type API struct {
