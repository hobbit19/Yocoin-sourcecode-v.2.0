...
func TestParseEnsAPIAddress(t *testing.T) {
	for _, x := range []struct {
	...
	}{
		{
			...
			value:       "/data/testnet/yocoin.ipc",
			endpoint:    "/data/testnet/yocoin.ipc",
		},
		{
		...
		},
		{
			...
			value:       "test:/data/testnet/yocoin.ipc",
			endpoint:    "/data/testnet/yocoin.ipc",
			tld:         "test",
		},
		{
		...
		},
		{
			...
			value:       "314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/yocoin.ipc",
			endpoint:    "/data/testnet/yocoin.ipc",
		...
		},
		{
			...
			value:       "test:314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/yocoin.ipc",
			endpoint:    "/data/testnet/yocoin.ipc",
			addr:        common.HexToAddress("314159265dD8dbb310642f98f50C066173C1259b"),
			tld:         "test",
		},
...
// https://github.com/yocsphere/go-yocoin/issues/639
