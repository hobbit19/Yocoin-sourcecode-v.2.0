...
import (
	...
	"github.com/Yocoin15/Yocoin_Sources/swarm/network/simulation"
	"github.com/Yocoin15/Yocoin_Sources/swarm/pot"
	"github.com/Yocoin15/Yocoin_Sources/swarm/state"
	"github.com/Yocoin15/Yocoin_Sources/swarm/storage"
	mockdb "github.com/Yocoin15/Yocoin_Sources/swarm/storage/mock/db"
)
...
func testSyncingViaGlobalSync(t *testing.T, chunkCount int, nodeCount int) {
	...
	result := sim.Run(ctx, func(ctx context.Context, sim *simulation.Simulation) error {
		...
		if *useMockStore {
			...
			if err != nil {
				return fmt.Errorf("Somyocing went wrong; using mockStore enabled but globalStore is nil")
			}
			defer func() {
				os.RemoveAll(gDir)
