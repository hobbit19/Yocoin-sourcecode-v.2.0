...
# 1. install yocoin for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for yocoin
# 5. create yocoin, attach and uninstall start menu entries
...
!define GROUPNAME "Yocoin"
!define APPNAME "Yocoin"
!define DESCRIPTION "Official Yocoin command line software"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since yocoin is installed global
