...
import (
	...
	"github.com/Yocoin15/Yocoin_Sources/signer/core"
	"github.com/Yocoin15/Yocoin_Sources/signer/rules/deps"
	"github.com/Yocoin15/Yocoin_Sources/signer/storage"
...
func (r *rulesetUI) OnApprovedTx(tx yocapi.SignTransactionResult) {
