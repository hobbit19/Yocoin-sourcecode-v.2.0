require = function e(t, n, r) {
  ...
  SolidityEvent.prototype.execute = function(indexed, options, callback) {
    ...
    var formatter = this.decode.bind(this);
// NOTE rechec this "eth" to not be currency
    return new Filter(o, "eth", this._requestManager, watches.eth(), formatter, callback);
  };
  ...
  Object.defineProperty(Eth.prototype, "defaultBlock", {get:function() {
    return c.defaultBlock;
  }, set:function(val) {
    c.defaultBlock = val;
    return val;
  }});
  Object.defineProperty(Eth.prototype, "defaultAccount", {get:function() {
  ...
  var methods = function() {
    var getBalance = new Method({name:"getBalance", call:"eth_getBalance", params:2, inputFormatter:[formatters.inputAddressFormatter, formatters.inputDefaultBlockNumberFormatter], outputFormatter:formatters.outputBigNumberFormatter});
    var getStorageAt = new Method({name:"getStorageAt", call:"eth_getStorageAt", params:3, inputFormatter:[null, utils.toHex, formatters.inputDefaultBlockNumberFormatter]});
    var getCode = new Method({name:"getCode", call:"eth_getCode", params:2, inputFormatter:[formatters.inputAddressFormatter, formatters.inputDefaultBlockNumberFormatter]});
    ...
    var getCompilers = new Method({name:"getCompilers", call:"eth_getCompilers", params:0});
    ...
    var getTransaction = new Method({name:"getTransaction", call:"eth_getTransactionByHash", params:1, outputFormatter:formatters.outputTransactionFormatter});
    ...
    var getTransactionReceipt = new Method({name:"getTransactionReceipt", call:"eth_getTransactionReceipt", params:1, outputFormatter:formatters.outputTransactionReceiptFormatter});
    var getTransactionCount = new Method({name:"getTransactionCount", call:"eth_getTransactionCount", params:2, inputFormatter:[null, formatters.inputDefaultBlockNumberFormatter], outputFormatter:utils.toDecimal});
    var sendRawTransaction = new Method({name:"sendRawTransaction", call:"eth_sendRawTransaction", params:1, inputFormatter:[null]});
    var sendTransaction = new Method({name:"sendTransaction", call:"eth_sendTransaction", params:1, inputFormatter:[formatters.inputTransactionFormatter]});
    var signTransaction = new Method({name:"signTransaction", call:"eth_signTransaction", params:1, inputFormatter:[formatters.inputTransactionFormatter]});
    var sign = new Method({name:"sign", call:"eth_sign", params:2, inputFormatter:[formatters.inputAddressFormatter, null]});
    ...
    var estimateGas = new Method({name:"estimateGas", call:"eth_estimateGas", params:1, inputFormatter:[formatters.inputCallFormatter], outputFormatter:utils.toDecimal});
    var compileSolidity = new Method({name:"compile.solidity", call:"eth_compileSolidity", params:1});
    var compileLLL = new Method({name:"compile.lll", call:"eth_compileLLL", params:1});
    var compileSerpent = new Method({name:"compile.serpent", call:"eth_compileSerpent", params:1});
    var submitWork = new Method({name:"submitWork", call:"eth_submitWork", params:3});
    var getWork = new Method({name:"getWork", call:"eth_getWork", params:0});
  ...
  var eth = function() {
    ...
    var uninstallFilter = new Method({name:"uninstallFilter", call:"eth_uninstallFilter", params:1});
    var getLogs = new Method({name:"getLogs", call:"eth_getFilterLogs", params:1});
    var poll = new Method({name:"poll", call:"eth_getFilterChanges", params:1});
  ...
  module.exports = {eth:eth, shh:shh};
  ...
  var pollSyncing = function(self) {
    ...
    self.requestManager.startPolling({method:"eth_syncing", params:[]}, self.pollId, onMessage, self.stopWatching.bind(self));
  };
  ...
  var transferToAddress = function(eth, from, to, value, callback) {
    return eth.sendTransaction({address:to, from:from, value:value}, callback);
  };
  var deposit = function(eth, from, to, value, client, callback) {
    var abi = exchangeAbi;
    return eth.contract(abi).at(to).deposit(client, {from:from, value:value}, callback);
  };
